...
export const EXPERIENCE: {
  ...
  { n: '02', org: 'Alice Calls', href: 'https://alicecalls.vercel.app', role: 'Founding Software Engineer', dates: ['Apr – Aug', '2026'], desc: 'Shipped a 24/7 AI voice receptionist (Retell AI, ElevenLabs, Cal.com) on live customer phone lines: intent handling, booking, CRM sync and bilingual Spanish/English. Closed paying customers through 200+ cold calls and owned product, deployment and sales end to end.' },
