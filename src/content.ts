...
export const EXPERIENCE = [
  { n: '01', org: 'Toggle Holdings', role: 'Software Engineer Intern', dates: ['May – Aug', '2026'], desc: 'Built and deployed a multi-agent compliance system for talent acquisition, saving ~15 hours a week. Set up internal MCPs and multi-agent orchestration for the agent platform, and shipped an agent that listens to live sales calls and fills in the spreadsheets, saving ~10 more.' },
  ...
  { n: '03', org: 'Nurturance', role: 'SDR', dates: ['Aug – Sep', '2026'], desc: 'Cold-called 10,000+ prospects and booked ~100 deals across three client pipelines, B2B and B2C. Discovered ICPs, wrote the pitches, and delivered them.' },
